...
class CowTemptAIImpl: PathfinderGoal, CowTemptAI {
    private var px = 0.0
    private var py = 0.0
    private var pz = 0.0
    ...
    constructor(cow:Cow, mob: EntityCreature, speedModifier: Double, items: ItemStack, canScare: Boolean):super(){
        this.mob = mob
    ...
    override fun canUse(): Boolean {
        if (this.calmDown > 0) {
            ...
            for (nearbyEntity in cow.getNearbyEntities(5.0, 5.0, 5.0)) {
    ...
    override fun createPathfinderGoal(cow: Cow, item: ItemStack): Any {
        return CowTemptAIImpl(cow,(cow as CraftCow).handle, 1.25, item, false)
    }
