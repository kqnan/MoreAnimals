...
class ChickenTemptAIImpl: PathfinderGoal, ChickenTemptAI {
    private var px = 0.0
    private var py = 0.0
    private var pz = 0.0
    ...
    private lateinit var chicken: Chicken
    constructor(chicken: Chicken, mob: EntityCreature, speedModifier: Double, items: ItemStack, canScare: Boolean):super(){
        this.mob = mob
    ...
    override fun canUse(): Boolean {
        if (this.calmDown > 0) {
            ...
            for (nearbyEntity in chicken.getNearbyEntities(5.0, 5.0, 5.0)) {
    ...
    override fun createPathfinderGoal(chicken: Chicken, item: ItemStack): Any {
        return ChickenTemptAIImpl(chicken,(chicken as CraftChicken).handle, 1.0, item, false)
    }
